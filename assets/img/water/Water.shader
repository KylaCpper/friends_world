...
void vertex()
{
	...
	vec3	vertex_position  = (WORLD_MATRIX * vertex).xyz;
			...
			vertex 			+= wave(wave_a, vertex_position.xz, time, vertextangent, vertexbinormal);
			vertex 			+= wave(wave_b, vertex_position.xz, time, vertextangent, vertexbinormal);
			vertex 			+= wave(wave_c, vertex_position.xz, time, vertextangent, vertexbinormal);
			...
			vertex_normal	 = normalize(cross(vertexbinormal, vertextangent));
