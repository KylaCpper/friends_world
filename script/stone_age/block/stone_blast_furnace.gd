extends Furnace
#de2,de<>1,-de0,-de<>3
var check_build_mat = "stone_brick"
var check_build_vecs = [
	[Vector3(-1,2,0),"stone_brick"],[Vector3(0,2,0),"stone_brick"],[Vector3(1,2,0),"stone_brick"],
	[Vector3(-1,1,0),"stone_brick"],[Vector3(0,1,0),"stone_brick"],[Vector3(1,1,0),"stone_brick"],
	[Vector3(-1,0,0),"stone_brick"],								[Vector3(1,0,0),"stone_brick"],
...
var build_mat = "stone_blast_furnace_brick"
var build_vecs = [
	[Vector3(-1,2,0),"stone_blast_furnace_brick"],[Vector3(0,2,0),"stone_blast_furnace_brick"],[Vector3(1,2,0),"stone_blast_furnace_brick"],
	[Vector3(-1,1,0),"stone_blast_furnace_brick"],[Vector3(0,1,0),"stone_blast_furnace_brick"],[Vector3(1,1,0),"stone_blast_furnace_brick"],
	[Vector3(-1,0,0),"stone_blast_furnace_brick"],												[Vector3(1,0,0),"stone_blast_furnace_brick"],
...
var unbuilding_name := "stone_furnace"
...
var img_front :=preload("res://script/stone_age/img/stone_blast_furnace0.png") 
var img_other := preload("res://script/stone_age/img/stone_blast_furnace00.png")
var ani_list = [
	preload("res://script/stone_age/img/stone_blast_furnace1.png"),
	preload("res://script/stone_age/img/stone_blast_furnace2.png"),
	preload("res://script/stone_age/img/stone_blast_furnace3.png"),
	preload("res://script/stone_age/img/stone_blast_furnace4.png"),
]
...
func _event(world_pos3:Vector3,block_name:String,dire:int) -> bool:
	...
	Overall.gui_node_node.change_ui("stone_blast_furnace","stone_blast_furnace")
	return true
...
#	var dire = Block.get_dire(Overall.terrain_main_node.get_id(pos3))
	...
	if !"e" in data:
		data["e"] = energy_offset
	if Terrain.find_conform_block(pos3,dires,"wood_blower"):
		if data.e == 1.2:
			data.e = 1.3
			if data.energy:
				var fuel = Item.get(data.fuel).fuel
