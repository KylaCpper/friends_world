...
var building_name := "stone_blast_furnace"
...
var img_front :=preload("res://script/stone_age/img/stone_furnace0.png")
var img_other := preload("res://script/stone_age/img/stone_furnace1.png")

var material_work = preload("res://assets/model/material.tres").duplicate()
var ani_list = [
	preload("res://script/stone_age/img/stone_furnace2.png"),
	preload("res://script/stone_age/img/stone_furnace3.png"),
	preload("res://script/stone_age/img/stone_furnace4.png"),
	preload("res://script/stone_age/img/stone_furnace5.png"),
	preload("res://script/stone_age/img/stone_furnace6.png"),
]
...
#			list[key].list.remove(1)
#			list[key].export_list.remove(1)
...
func _event(world_pos3:Vector3,block_name:String,dire:int) -> bool:
	...
	Overall.gui_node_node.change_ui("stone_furnace","stone_furnace")
	return true
